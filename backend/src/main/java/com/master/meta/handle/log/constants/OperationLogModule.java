...
public class OperationLogModule {
    ...
    public static final String SETTING_ORGANIZATION_TEMPLATE_SCHEDULE_FIELD = "SETTING_ORGANIZATION_TEMPLATE_SCHEDULE_FIELD";
    // 模板管理-模板
    ...
    public static final String PROJECT_MANAGEMENT_TEMPLATE_SCHEDULE_TEMPLATE = "PROJECT_MANAGEMENT_TEMPLATE_SCHEDULE_TEMPLATE";
    // 项目模板管理-状态流
    ...
    public static final String PROJECT_MANAGEMENT_TEMPLATE_SCHEDULE_FIELD = "PROJECT_MANAGEMENT_TEMPLATE_SCHEDULE_FIELD";
