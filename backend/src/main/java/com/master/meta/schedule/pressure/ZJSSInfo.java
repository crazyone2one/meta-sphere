...
public class ZJSSInfo extends BaseScheduleJob {
    ...
    private ZJSSInfo(SensorUtil sensorUtil) {
        this.sensorUtil = sensorUtil;
    }

    @Override
    protected void businessExecute(JobExecutionContext context) {
        List<Row> sensorInRedis = sensorUtil.getSensorFromRedis(super.projectNum, "ZJZL", "sf_ky_zjzl", false);
        // 获取为删除的数据
        ...
        if (CollectionUtils.isNotEmpty(sensorList)) {
            ...
            String fileName = super.projectNum + "_ZJSS_" + DateFormatUtil.localDateTimeToString(now) + ".txt";
