...
public class HDWYSSInfo extends BaseScheduleJob {
    private HDWYSSInfo(SensorService sensorService, FileManager fileManager, FileTransferConfiguration fileTransferConfiguration) {
    ...
    protected void businessExecute(JobExecutionContext context) {
        ...
        fileManager.writeToFile(filePath, JSON.toJSONString(content), "巷道位移测点实时数据[" + fileName + "]");
